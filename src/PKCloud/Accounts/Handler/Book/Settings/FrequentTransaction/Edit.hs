module PKCloud.Accounts.Handler.Book.Settings.FrequentTransaction.Edit where

import qualified Account
import qualified Book
import qualified Breadcrumb
import qualified FrequentTransaction
import           PKCloud.Accounts.Handler.Book.Settings.FrequentTransaction.Create hiding (generateHTML)
import           PKCloud.Accounts.Handler.Transaction.Create (insertTransactionAccount)
import           Import
